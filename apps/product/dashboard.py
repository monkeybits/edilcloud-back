...
class Models(modules.ModelList):
    def __init__(self, **kwargs):
        kwargs.update({
            'title': _("main models"),
            'models': (
                'product.models.Unit', 'product.models.Typology', 'product.models.Category',
                'product.models.Subcategory',
...
jmb_dashboard.register_group(MainDashboard, 'product')
admin_tools.dashboard.register(DefaultAppDashboard, 'product')
