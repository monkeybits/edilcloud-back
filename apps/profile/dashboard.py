...
class Models(modules.ModelList):
    def __init__(self, **kwargs):
        kwargs.update({
            'title': _("main models"),
            'models': (
                'profile.models.Company', 'profile.models.Profile', 'profile.models.Invite', 'profile.models.Favourite',
            ),
        })
...
jmb_dashboard.register_group(MainDashboard, 'profile')
admin_tools.dashboard.register(DefaultAppDashboard, 'profile')
