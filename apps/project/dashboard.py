...
class Models(modules.ModelList):
    def __init__(self, **kwargs):
        kwargs.update({
            'title': _("main models"),
            'models': ('project.models.Project', 'project.models.Task',
                       ),
        })
...
jmb_dashboard.register_group(MainDashboard, 'project')
admin_tools.dashboard.register(DefaultAppDashboard, 'project')
