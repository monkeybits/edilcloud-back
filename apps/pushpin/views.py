...
from web.settings import PROJECT_PATH, BASE_DIR
...
def home(request, room_id=None):
    ...
    if user:
        ...
        context['messages'] = "ciaoo"#msgs
        context['user'] = user
        return render(request, BASE_DIR + '/apps/pushpin/templates/chat.html', context)
    else:
        context = {}
        context['room_id'] = room_id or 'default'
        return render(request, BASE_DIR + '/apps/pushpin/templates/join.html', context)
