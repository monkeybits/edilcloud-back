...
class Models(modules.ModelList):
    def __init__(self, **kwargs):
        kwargs.update({
            'title': _("main models"),
            'models': ('quotation.models.Bom', 'quotation.models.BomRow', 'quotation.models.Quotation',
                       'quotation.models.QuotationRow', 'quotation.models.Offer', 'quotation.models.Certification',
                       ),
        })
...
jmb_dashboard.register_group(MainDashboard, 'quotation')
admin_tools.dashboard.register(DefaultAppDashboard, 'quotation')
